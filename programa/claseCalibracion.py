...
def guardar_calibracion(tipoCanal,tipoCurva,parametros,covarianzas,dosis,transmitancias,ceros,incertidumbres,funcionesRGB,funcionCalDel,funcionTaD,labels,nombreArchivo):
    ...
    dis={"Nombre":nombreArchivo,"TipoCanal":tipoCanal,"TipoCurva":tipoCurva,"Parametros":parametros,"Covarianzas":covarianzas,"Dosis":dosis,"Dopticas":transmitancias,"Ceros":ceros,"Incertidumbres":incertidumbres,"funcionesRGB":funcionesRGB,"funcionCalDel":funcionCalDel,"labels":labels,"funcionTaD":funcionTaD}
